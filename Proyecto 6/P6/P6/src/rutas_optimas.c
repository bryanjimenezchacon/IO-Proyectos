...
int main(int argc, char *argv[])
{
    ...
    gtk_widget_modify_bg ( GTK_WIDGET(window_aux), GTK_STATE_NORMAL, &color1);
    gtk_widget_modify_bg ( GTK_WIDGET(windowTablas), GTK_STATE_NORMAL, &color1);
    gtk_widget_modify_bg ( GTK_WIDGET(windowGrafo), GTK_STATE_NORMAL, &color1);
